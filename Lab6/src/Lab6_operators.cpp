...
public:
    ...
    void operator-(const Lab6 & x);//couple of my own examples
...
int main()
{
    ...
    if(obj1 > obj2)    // normal expression. Which operator is being called?
        // the one being call should be member function >
    ...
    // they will not work, function is defined this way
    obj1.Printvals();
    obj2.Printvals();
    ...
    // Lab6 obj5 = obj1 + obj2;    //This way will work only
    
    obj3 = operator+(obj2, obj1);    // is this the same as before?
    // yes, addition is same
    obj1.Printvals();
    obj2.Printvals();
    obj3.Printvals();
    
    //some examples using operator-
    cout << "\ncouple of my own example" << endl;
    obj2 - obj1;
    obj1.Printvals();
    obj2.Printvals();
    obj3.Printvals();
    
    //couple examples to show - and + is wokring
    Lab6 obj4;
    obj4.a[0] = 3;
    obj4.a[1] = 4;
    obj1 - obj3;
